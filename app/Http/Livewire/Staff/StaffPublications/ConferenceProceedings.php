...
namespace App\Http\Livewire\Staff\StaffPublications;
...
class ConferenceProceedings extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.staff.staff-publications.proceedings', [
