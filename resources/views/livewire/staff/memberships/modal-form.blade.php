<!-- Edit Modal -->
<div wire:ignore.self class="modal fade" id="updateMembershipModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Edit Membership</h1>
                ...
                <form wire:submit.prevent="updateMembership()">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Society</label>
                            <input type="text" wire:model.defer="society" class="form-control" placeholder="Society" required>
                            @error('society') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
...
<!-- DELETE MODAL -->
<div wire:ignore.self class="modal fade" id="deleteMembershipModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Delete Membership</h1>
                <button type="button" class="btn-close" wire:click ="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div wire:loading class="py-5">
                <div class="d-flex justify-content-center align-items-center">
