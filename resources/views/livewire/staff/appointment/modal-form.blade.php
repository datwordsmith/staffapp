                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="date" wire:model.defer="appointment_date" class="form-control" required>
                            ...
                            <div class="col-md-4 form-group">
                                <label for="date">Date of Last Promotion</label>
                                <input type="date" wire:model.defer="last_promotion" class="form-control" required>
                                @error('last_promotion') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                        </div>
...
<div wire:ignore.self class="modal fade" id="deleteAppointmentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Delete Appointment</h1>
                <button type="button" class="btn-close" wire:click ="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div wire:loading class="py-5">
                <div class="d-flex justify-content-center align-items-center">
