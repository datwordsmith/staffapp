<div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @elseif (isset($staffAction) && ($staffAction->status_id == 5))
                <div class="alert alert-success }}">
                    <div class="d-flex justify-content-between w-100">
                        <span>Do you want to approve/decline this request?</span>
    ...
    <div class="row mt-3" id="aperReport">
        ...
        <div class="d-none d-print-block">
            ...
            @if($user->role_as == 2)
                ...
                <div class="col-md-12 mb-3">
                    <div class="card">
                        <div class="card-header text-white bg-gradient-primary pt-3"><h4>Scholarships/Prizes</h4></div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="awards"  style="width: 100%">
                                    ...
                                    <tbody>
                                        @if($awards->isEmpty())
                                            <tr>
                                                <td colspan="3" class="text-center">No Scholarships/Prizes found</td>
                                            </tr>
                                        @else
...
@section('scripts')
    <script>
        ...
        document.getElementById('downloadPdf').addEventListener('click', function () {
            ...
            // Capture the HTML content and generate PDF
            const element = document.querySelector('#aperReport');
            const opt = {
                margin: 0.5,
                filename: 'APER_Report.pdf',
            ...
            html2pdf().from(element).set(opt).save().then(() => {
                // Hide the previously shown elements
