    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form wire:submit.prevent="storeDepartment" class="">
                            ...
                            @forelse ($departments as $department)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-end">
                                        <a href="#" wire:click="editDepartment({{ $department->id }})" class="btn btn-sm btn-warning me-2" data-bs-toggle="modal" data-bs-target="#updateDepartmentModal"><i class="fa-solid fa-pen-nib"></i></a>
                                        <a href="#" wire:click="deleteDepartment({{ $department->id }})" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteDepartmentModal"><i class="fa-solid fa-trash-can"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
