<div>
    @include('livewire.staff.awards.modal-form')

    @section('pagename')
        <h3 class="page-title">
            <span class="page-title-icon bg-gradient-primary text-white me-2">
                <i class="fa-regular fa-thumbs-up menu-icon"></i>
            </span> Scholarships and Prizes
        </h3>
        @endsection
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3">All Scholarship/Prize Awards</h4>
                @if (session('message'))
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-danger text-center">No Scholarship/Prize Found</td>
                                </tr>
                            @endforelse
