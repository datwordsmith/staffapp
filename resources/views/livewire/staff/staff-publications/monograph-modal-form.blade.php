                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label class="form-label"><small>Title of Monograph/Book</small></label>
                                <input type="text" wire:model.defer="title" class="form-control" placeholder="Title of Monograph/Book" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                                <label class="form-label"><small>ISBN</small></label>
                                <input type="text" wire:model.defer="journal_volume" class="form-control" placeholder="ISBN" required>
...
<div wire:ignore.self class="modal fade" id="updatePublicationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content p-4">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Update Monograph/Book</h1>
                <button type="button" class="btn-close" wire:click="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div wire:loading class="py-5">
                <div class="d-flex justify-content-center align-items-center">
...
<div wire:ignore.self class="modal fade" id="deletePublicationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Delete Monograph/Book</h1>
                <button type="button" class="btn-close" wire:click ="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div wire:loading class="py-5">
                <div class="d-flex justify-content-center align-items-center">
            ...
            <div wire:loading.remove>
                <form wire:submit="destroyPublication()">
                    <div class="modal-body">
                        <h4>Are you sure you want to delete this Monograph/Book?</h4>
                    </div>
                    <div class="modal-footer">
